...
- **엔진 및 언어**: Unity, C# (순수 도메인 분리)
- **아키텍처 및 디자인 패턴**: 헥사고날 아키텍처 (Ports and Adapters), 상태 머신 (FSM), Observer 패턴
- **핵심 기술 및 시스템**: 물리적 이동 기반 트랜잭션 자원 시스템, PlayMode 통합 테스트 스위트 기반 자동화 검증
